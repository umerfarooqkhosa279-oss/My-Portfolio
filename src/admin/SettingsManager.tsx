...
const settingGroups: Record<string, { title: string; fields: { name: string; label: string; type?: string; bucket?: string; folder?: string }[] }> = {
  branding: { title: 'Branding Settings', fields: [{ name: 'websiteName', label: 'Website Name' }, { name: 'heroBadgeText', label: 'Hero Badge Text' }, { name: 'logoUrl', label: 'Logo', type: 'file', bucket: 'portfolio-assets', folder: 'branding' }, { name: 'faviconUrl', label: 'Favicon', type: 'file', bucket: 'portfolio-assets', folder: 'branding' }, { name: 'footerText', label: 'Footer Text' }] },
